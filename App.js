...
const Header = () => {
  return <div className="header">
    <div className="logo-container">
      <img src="https://tse3.mm.bing.net/th/id/OIP.eyFnutyvj4Pu_a5YsSfvfQHaEp?pid=Api&P=0&h=180" className="logo"/>
    </div>
...
const RestaurantCard = (props) => {
  ...
  return <div className="res-card" style={{backgroundColor: "#f0f0f0"}}>
    <img alt="res image" className="res-logo" src={"https://res.cloudinary.com/swiggy/image/upload/fl_lossy,f_auto,q_auto,w_508,h_320,c_fill/" + cloudinaryImageId}/>
    <h3>{name}</h3>
    <h4>{avgRating}</h4>
    <h4>{cuisines.join(", ")}</h4>
    <h4>{costForTwo}</h4>
